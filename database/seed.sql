...
FROM (
  SELECT 'visiting-cards' category_slug, 'visiting-cards-standard-visiting-cards' slug, 'Standard Visiting Cards' name, 'Standard visiting cards from the Excel sheet with printing type and quantity options.' description, 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?auto=format&fit=crop&w=900&q=80' image_url, 199 starting_at, '500' quantity, '199 / 299 / 499 / 999' single_side_price, '299 / 399 / 799 / 1299' both_side_price, NULL offer_label, 0 offer_percent, 0 offer_active
  UNION ALL SELECT 'visiting-cards', 'visiting-cards-premium-visiting-cards', 'Premium Visiting Cards', 'Premium visiting cards from the Excel sheet with printing type, quantity and corner type options.', 'https://images.unsplash.com/photo-1601924582970-9238bcb495d9?auto=format&fit=crop&w=900&q=80', 799, '500', '799 / 1299 / 1899 / 2399', '999 / 1499 / 2099 / 2499', NULL, 0, 0
  UNION ALL SELECT 'flyers-pamphlets', 'flyers-pamphlets-90-gsm-flyers-glossy', '90 GSM Flyers (Glossy)', '90 GSM glossy flyers from the Excel sheet with size, printing type and quantity options.', '/src/assets/products/flyers-pamphlets-a5-flyers.webp', 1299, '5000', '1299 / 1699', '1699 / 1999', NULL, 0, 0
  UNION ALL SELECT 'bill-book', 'bill-book-bill-book-b-w', 'Bill Book B/W', 'Black-and-white bill book from the Excel sheet with size, printing type, copy and numbering options.', '/src/assets/products/office-printing-receipt-books.jpg', 1500, '5 Book', '1500 / 1800', NULL, NULL, 0, 0
  UNION ALL SELECT 'bill-book', 'bill-book-prescription-pads', 'Prescription Pads', 'Prescription pad from the Excel sheet with size, printing type and book quantity options.', 'https://images.unsplash.com/photo-1601924582970-9238bcb495d9?auto=format&fit=crop&w=900&q=80', 1799, '1 Book', NULL, NULL, NULL, 0, 0
  UNION ALL SELECT 'letter-head', 'letter-head-letterheads', 'Letterheads', 'Letterhead printing from the Excel sheet with quantity option.', '/src/assets/products/office-printing-letterheads.jpg', 2499, '3000', '2499', NULL, NULL, 0, 0
  UNION ALL SELECT 'envelope', 'envelope-envelopes', 'Envelopes', 'Envelope printing from the Excel sheet with quantity option.', '/src/assets/products/office-printing-envelopes.jpg', 2699, '200', '2699', NULL, NULL, 0, 0
  ...
  UNION ALL SELECT 'flex-printing', 'flex-printing-regular-flex', 'Regular Flex', 'Regular flex from the Excel sheet with size, custom width, custom height and quantity options.', '/src/assets/products/flex-printing-star-flex-printing.webp', 22, '2', NULL, NULL, NULL, 0, 0
  UNION ALL SELECT 'vinyl-printing', 'vinyl-printing-vinyl-printing', 'Vinyl Printing', 'Vinyl printing from the Excel sheet with size, custom width, custom height, lamination and quantity options.', '/src/assets/products/vinyl-printing-vinyl-printing.jpg', 25, '2', '25', NULL, NULL, 0, 0
