  ...
  head: () => ({
    meta: [
      ...
      { title: "Morya Printing Point | Custom Printing in Pune" },
      {
        name: "description",
        content:
          "Custom digital printing, flex printing, stickers, signage, labels and paper finishing from Morya Printing Point in Kothrud, Pune.",
      },
      { name: "author", content: "Morya Printing Point" },
      { property: "og:title", content: "Morya Printing Point | Custom Printing in Pune" },
      {
        property: "og:description",
        content: "Digital printing, flex, stickers, signage and custom branding in Kothrud, Pune.",
      },
